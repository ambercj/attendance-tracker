...
//        }
    ...
    public ArrayList<Log> list_students_late_to_class(String start_time){
        ArrayList<Log> late_student = new ArrayList<>();
        List<String> start_time_and_date = Arrays.asList(start_time.split(", "));
        List<String> start_time_list = Arrays.asList(start_time_and_date.get(0).split(":"));
        List<String> start_date_list = Arrays.asList(start_time_and_date.get(1).split("/"));
